...
static void softmax_rows_fp16(float probs[TOKENS][TOKENS],
...
extern "C" void attention_fp16(_Float16 O[BATCH][TOKENS][VALUE_DEPTH],
                                _Float16 Q[BATCH][TOKENS][DEPTH],
                                _Float16 K[BATCH][TOKENS][DEPTH],
                                _Float16 V[BATCH][TOKENS][VALUE_DEPTH]) {
  ...
  for (int b = 0; b < BATCH; ++b) {
    ...
    softmax_rows_fp16(probs, scores);
