...
static void softmax_rows_int8(float probs[TOKENS][TOKENS],
...
extern "C" void attention_int8(int8_t O[BATCH][TOKENS][VALUE_DEPTH],
                                int8_t Q[BATCH][TOKENS][DEPTH],
                                int8_t K[BATCH][TOKENS][DEPTH],
                                int8_t V[BATCH][TOKENS][VALUE_DEPTH]) {
  ...
  for (int b = 0; b < BATCH; ++b) {
    ...
    softmax_rows_int8(probs, scores);
